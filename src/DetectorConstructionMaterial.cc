...
DetectorConstructionMaterial::DetectorConstructionMaterial() {
  ...
  a=1.01*g/mole;
  elH=new G4Element(name="m_hydrogen",symbol="H2",z=1.,a);

  a=2.01*g/mole;
  elD=new G4Element(name="m_deuterium",symbol="D",z=1.,a);

  a=4.*g/mole;
  elHe=new G4Element(name="m_helium",symbol="He",z=2.,a);

  a=6.94*g/mole;
  elLi=new G4Element(name="m_lithium",symbol="Li",z=3.,a);

  a=9.01*g/mole;
  elBe=new G4Element(name="m_berillium",symbol="Be",z=4.,a);

  a=12.01*g/mole;
  elC=new G4Element(name="m_carbon",symbol="C",z=6.,a);

  a=14.01*g/mole;
  elN=new G4Element(name="m_nitrogen",symbol="N2",z=7.,a);

  a=16.*g/mole;
  elO=new G4Element(name="m_oxygen",symbol="O2",z=8.,a);

  a=20.18*g/mole;
  elNe=new G4Element(name="m_neon",symbol="Ne",z=10.,a);

  a=22.99*g/mole;
  elNa=new G4Element(name="m_sodium",symbol="Na",z=11.,a);

  a=24.305*g/mole;
  elMg=new G4Element(name="m_magnesium",symbol="Mg",z=12.,a);

  a=26.98*g/mole;
  elAl=new G4Element(name="m_aluminium",symbol="Al",z=13.,a);

  a=28.085*g/mole;
  elSi=new G4Element(name="m_silicon",symbol="Si",z=14.,a);
  
  a=30.973*g/mole;
  elP= new G4Element(name="m_phosphorus",symbol="P",z=15.,a);

  a=32.06*g/mole;
  elS=new G4Element(name="m_sulfur",symbol="S",z=16.,a);

  a=40.08*g/mole;
  elCa=new G4Element(name="m_calcium",symbol="Ca",z=20.,a);

  a=47.867*g/mole;
  elTi=new G4Element(name="m_titanium",symbol="Ti",z=22.,a);

  a=55.850*g/mole;
  elFe=new G4Element(name="m_iron",symbol="Fe",z=26.,a);

  a=63.54*g/mole;
  elCu=new G4Element(name="m_copper",symbol="Cu",z=29.,a);

  a=183.85*g/mole;
  elW=new G4Element(name="m_tungstenm",symbol="W",z=74.,a);

  a=207.19*g/mole;
  elPb=new G4Element(name="m_lead",symbol="Pb",z=82.,a);

  a=238.03*g/mole;
  elU=new G4Element(name="m_uranium",symbol="U",z=92.,a);
  ...
  density = 2.7*g/cm3;
  a = 26.98*g/mole;
  Aluminium = new G4Material(name="m_Aluminium",z=13.,a,density);
  FakeAluminium = new G4Material(name="m_FakeAluminium",z=13.,a,density/2);
  
  density = 7.87*g/cm3;
  a = 55.85*g/mole;
  Iron = new G4Material(name="m_Iron",z=26.,a,density);

  density = 8.96*g/cm3;
  a = 63.54*g/mole;
  Copper = new G4Material(name="m_Copper",z=29.,a,density);

  density = 19.3*g/cm3;
  a = 183.85*g/mole;
  Tungsten = new G4Material(name="m_Tungsten",z=74.,a,density);

  density = 11.35*g/cm3;
  a = 207.19*g/mole;
  Lead = new G4Material(name="m_Lead",z=82.,a,density);

  density = 1.4*g/cm3;
  a = 39.95*g/mole;
  LiquidArgon = new G4Material(name="m_LiquidArgon",z=18.,a,density);

  density = 2.413*g/cm3;
  a = 84*g/mole;
  LiquidKrypton = new G4Material(name="m_LiquidKrypton",z=36.,a,density);

  density = 0.002*g/cm3;
  a = 39.95*g/mole;
  ArgonGas = new G4Material(name="m_ArgonGas",z=18.,a,density);

  density = 8.96*g/cm3;
  a = 58.69*g/mole;
  Nickel = new G4Material(name="m_Nickel",z=28.,a,density);
  ...
  Air = new G4Material(name="m_Air",density, nel=2);
  ...
  Vacuum = new G4Material(name="m_Vacuum", density, nel=1,
			  kStateGas,temperature,pressure);
  Vacuum->AddMaterial(Air, fractionmass=1.);

  density = 1.977*mg/cm3;
  CO2 = new G4Material(name="m_CO2", density, nel=2);
  CO2->AddElement(elC, 1);
  CO2->AddElement(elO, 2);

  density = 2.2*g/cm3;
  SiO2 = new G4Material(name="m_SiO2", density, nel=2);
  SiO2->AddElement(elSi, 1);
  SiO2->AddElement(elO, 2);

  density = 1.562*g/cm3;
  P2O5 = new G4Material(name="m_P2O5", density, nel=2);
  P2O5->AddElement(elP, 2);
  P2O5->AddElement(elO, 5);

  density = 3.97*g/cm3;
  Al2O3 = new G4Material(name="m_Al2O3", density, nel=2);
  Al2O3->AddElement(elAl, 2);
  Al2O3->AddElement(elO, 3);

  density = 5.24*g/cm3;
  Fe2O3 = new G4Material(name="m_Fe2O3", density, nel=2);
  Fe2O3->AddElement(elFe, 2);
  Fe2O3->AddElement(elO, 3);

  density = 5.745*g/cm3;
  FeO = new G4Material(name="m_FeO", density, nel=2);
  FeO->AddElement(elFe, 1);
  FeO->AddElement(elO, 1);

  density = 3.35*g/cm3;
  CaO = new G4Material(name="m_CaO", density, nel=2);
  CaO->AddElement(elCa, 1);
  CaO->AddElement(elO, 1);

  density = 3.58*g/cm3;
  MgO = new G4Material(name="m_MgO", density, nel=2);
  MgO->AddElement(elMg, 1);
  MgO->AddElement(elO, 1);

  density = 2.27*g/cm3;
  Na2O = new G4Material(name="m_Na2O", density, nel=2);
  Na2O->AddElement(elNa, 2);
  Na2O->AddElement(elO, 1);

  density = 4.23*g/cm3;
  TiO2 = new G4Material(name="m_TiO2", density, nel=2);
  TiO2->AddElement(elTi, 1);
  TiO2->AddElement(elO, 2);

  // must have the right composition for stainless steel
  density = 8.96*g/cm3;
  StainlessSteel = new G4Material(name="m_StainlessSteel",density,nel=1);
  StainlessSteel->AddElement(elO, fractionmass = 1.);

  // LS
  density = 0.859*g/cm3;
  LS = new G4Material(name="m_LiquidScintillator", density, nel=5);
  ...
  density = 1.032*g/cm3;
  polystyrene = new G4Material(name="m_Polystyrene", density, nel=2);
  polystyrene->AddElement(elC, natoms=19);
  polystyrene->AddElement(elH, natoms=21);

  density = 2.58*g/cm3;
  fibrous_glass = new G4Material(name="m_fibrous_glass", density, 7);
  ...
  density = 0.13*g/cm3;
  polyurethane_foam = new G4Material(name="m_polyurethane_foam", density, 7);
  ...
  R_PUF = new G4Material("m_R_PUF", density, 2);
  R_PUF->AddMaterial(polyurethane_foam, 0.95);
  R_PUF->AddMaterial(fibrous_glass    , 0.05);

  // Rock
  density = 2.82*g/cm3;
  Rock = new G4Material(name="m_Rock", density, 11);
