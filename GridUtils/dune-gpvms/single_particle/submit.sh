...
jobsub_submit -N $n_jobs -G dune --expected-lifetime=8h --memory=8000MB --disk=8GB --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC file://./batch_script.sh $file_list $macro $out_dir
